  ...
  return (
    <div>
      <div className="flex justify-between px-3 py-2">
        ...
        <IoIosMore className="text-3xl active:bg-slate-200" />
      </div>
              ...
              <div className="flex-1 p-3">
                ...
                {withRemoveButton ? (
                  <div className="mt-4 flex justify-between flex-1 items-end justify-between *:text-sm">
                    ...
                    <Button variant="outlined" className="border ml-auto">Remove</Button>
                  </div>
                ) : (
                  <div className="mt-4">
                    <Button className="flex gap-2 w-full border border-primary text-primary active:bg-primary/10 " variant="outlined">
      ...
      <div className="text-center py-3 px-4 ">
        <span className="inline-flex gap-2 items-center active:bg-slate-200 p-2 mx-auto">See All <FaChevronRight /></span>
      </div>
    </div>
  )
}